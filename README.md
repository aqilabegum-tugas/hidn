...
| Fitur | Status |
|---|---|
| 🔐 **Login & Register** (email + password, JWT, bcrypt) | ✅ |
| 🧠 **Kuis Kepribadian Wisata** (7 pertanyaan, 5 tipe) | ✅ |
| 🗺 **Hidden Gem Discovery** (filter, sort, search) | ✅ |
| 📅 **Smart Itinerary** (per hari, per jam) | ✅ |
| 🎨 **Customizable Plan** (save, edit, delete) | ✅ |
| 💚 **Save destinasi favorit** (per user) | ✅ |
| ❌ AI matching destinasi | _Skip — pakai rule-based_ |

> 🔒 **Halaman wajib login:** Quiz, Hasil Kuis, Detail Destinasi, Itinerary, Saved.
> Halaman bebas: Beranda & Hidden Gems (Discover).

---

## 👤 Akun Demo (sudah otomatis dibuat saat pertama kali run Docker)
...
Atau klik tombol **Daftar** di Navbar untuk bikin akun baru.
